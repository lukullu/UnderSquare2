...
public class Weapon extends Item implements Serializable {
	...
	public static final Weapon MACHINEGUN      = new Weapon("Machinegun",      Color.gray, bulletConstruction, new Vector2(5,10),4,  new Vector2(600000 ,600000 ),   new Vector2(40000,40000  ), 10 , 3   , 10  , 0.25f );
	...
	public static final Weapon ORBIT           = new Weapon("Orbit",           Color.gray, orbitConstruction,  new Vector2(5,10),6,  new Vector2(100000 ,100000 ),   ZERO_VECTOR_2,                     3  , 30  , 40  , 0.5f  );
